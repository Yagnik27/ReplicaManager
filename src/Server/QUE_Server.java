...
public class QUE_Server {
    ...
    public QUE_Server() {
        this.serverID = "QUE";
        this.serverName = AppointmentConstants.APPOINTMENT_SERVER_QUEBEC;
        //this.serverRegistryPort = Patient.SERVER_PORT_QUEBEC;
        this.serverUdpPort = DAMSInterfaceImplementation.Quebec_Server_Port;
    }

    public static void main(String args[]) throws Exception{

        QUE_Server que_server = new QUE_Server();

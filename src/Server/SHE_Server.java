...
public class SHE_Server{
    ...
    public SHE_Server() {
        this.serverID = "SHE";
        this.serverName = AppointmentConstants.APPOINTMENT_SERVER_SHERBROOKE;
        //this.serverRegistryPort = Patient.SERVER_PORT_SHERBROOKE;
        this.serverUdpPort = DAMSInterfaceImplementation.Sherbrooke_Server_Port;
    }

    public static void main(String args[]) throws Exception{

        SHE_Server she_server = new SHE_Server();
